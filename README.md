...
I'm a passionate **Computer Science & Engineering** undergraduate specializing in **Data Science** at the *Indore Institute of Science and Technology (IIST), Indore*. I thrive at the intersection of AI, data, and real-world problem-solving — constantly exploring new technologies to build impactful, meaningful projects.

- 🎓 **Pursuing:** B.Tech in CSE with Specialization in Data Science
...
![Weka](https://img.shields.io/badge/Weka-CC0000?style=for-the-badge&logo=python&logoColor=white)
...
I'm actively looking to work on projects that:
- Solve **real-world challenges** using data and AI
- Involve **open-source contributions** with a positive impact
- Bridge the gap between **research and practical applications**

If you have an idea or are looking for a collaborator, feel free to reach out — I'm always open to exciting opportunities!
